...
import { usePathname } from 'next/navigation'; // Import usePathname to prevent stuck loader
...
export default function CustomLink({
  ...
  const handleClick = (e: React.MouseEvent<HTMLAnchorElement>) => {
    // Prevent getting stuck on loader if navigating to exactly the same URL
