...
import { getGroqResponse, formatMessagesForGroq, generateChatTitle } from '@/lib/groq'; // Import Groq helpers
...
export async function POST(
  ...
  try {
    ...
    // 4. Call Groq API for AI Response
    const groqHistory = formatMessagesForGroq(currentMessages); // Format DB messages for Groq
    const aiResponseContent = await getGroqResponse(groqHistory, userMessageContent); // Get AI's response
