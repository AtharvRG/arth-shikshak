...
export default function SignupPage() {
  ...
  const handleGoogleSignUp = async () => {
    setIsLoading(true);
    // Setting callbackUrl to dashboard - if they are new, they might need onboarding, which your dashboard/app layout can handle.
    // Or we can direct to onboarding/step1 directly. We'll use onboarding/step1 as credential signup does.
         ...
         <div className="w-full max-w-md p-8 space-y-6 bg-black/70 backdrop-blur-md rounded-lg shadow-2xl border border-neutral-800">
           ...
           <div className="relative my-4">
             ...
             <div className="relative flex justify-center text-xs uppercase">
               <span className="bg-[#111] px-2 text-neutral-400">Or continue with</span>
             </div>
           </div>
           ...
           <MovingBorderButton
             ...
             className={`bg-neutral-900 border-neutral-800 text-white text-base font-semibold flex items-center justify-center gap-2 transition-colors duration-300 ${isLoading ? 'opacity-50 cursor-not-allowed' : 'hover:bg-neutral-800'}`}
             disabled={isLoading}
           >
